...
const ordersData = [
  { id: "ORD-5001", customer: { name: "John Doe", email: "john@example.com", phone: "+8801700000001" }, amount: "৳150.00", paymentMethod: "Card", paymentStatus: "Paid", date: "15 Mar 2024", time: "10:30 AM", orderStatus: "Processing", parcelStatus: "Not Added" },
  { id: "ORD-5002", customer: { name: "Jane Smith", email: "jane@example.com", phone: "+8801700000002" }, amount: "৳85.50", paymentMethod: "COD", paymentStatus: "Pending", date: "15 Mar 2024", time: "02:15 PM", orderStatus: "Shipped", parcelStatus: "Added" },
  { id: "ORD-5003", customer: { name: "Alice Johnson", email: "alice@example.com", phone: "+8801700000003" }, amount: "৳210.00", paymentMethod: "Bkash", paymentStatus: "Paid", date: "14 Mar 2024", time: "11:45 AM", orderStatus: "Delivered", parcelStatus: "Returned" },
  { id: "ORD-5004", customer: { name: "Bob Brown", email: "bob@example.com", phone: "+8801700000004" }, amount: "৳45.00", paymentMethod: "Card", paymentStatus: "Paid", date: "14 Mar 2024", time: "04:20 PM", orderStatus: "Processing", parcelStatus: "Not Added" },
  { id: "ORD-5005", customer: { name: "Charlie Davis", email: "charlie@example.com", phone: "+8801700000005" }, amount: "৳320.00", paymentMethod: "Bank Transfer", paymentStatus: "Paid", date: "13 Mar 2024", time: "09:00 AM", orderStatus: "Shipped", parcelStatus: "Added" },
  { id: "ORD-5006", customer: { name: "Diana Evans", email: "diana@example.com", phone: "+8801700000006" }, amount: "৳90.00", paymentMethod: "COD", paymentStatus: "Pending", date: "12 Mar 2024", time: "01:30 PM", orderStatus: "Returned", parcelStatus: "Returned" },
];
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="text-xs">
                ...
                <DropdownMenuItem disabled={selectedCount === 0 || !table.getSelectedRowModel().rows.every(r => r.original.parcelStatus === "Not Added")}>
                  <Truck className="mr-2 h-3.5 w-3.5" />
                  Bulk Send to Pathao
                </DropdownMenuItem>
                <DropdownMenuItem disabled={selectedCount === 0 || !table.getSelectedRowModel().rows.every(r => r.original.orderStatus === "Returned")}>
