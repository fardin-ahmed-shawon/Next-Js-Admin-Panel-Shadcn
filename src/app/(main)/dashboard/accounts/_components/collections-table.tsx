...
const mockData: FinancialCollectionItem[] = [
  {
    id: "TRX-001",
...
const columns: ColumnDef<FinancialCollectionItem>[] = [
  {
    id: "search",
...
export function CollectionsTable() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-normal text-muted-foreground text-sm">All Collections</CardTitle>
      </CardHeader>
                ...
                <TableRow>
                  <TableCell colSpan={table.getVisibleLeafColumns().length} className="h-24 text-center">
                    <div className="flex flex-col items-center justify-center gap-3 py-8">
                      ...
                      <p className="text-sm font-medium text-muted-foreground">No collections found</p>
                    </div>
                  </TableCell>
                </TableRow>
              )}
