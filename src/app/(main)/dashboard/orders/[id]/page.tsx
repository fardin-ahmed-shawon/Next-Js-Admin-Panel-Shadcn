...
export default function OrderDetailPage() {
  ...
  const order = React.useMemo(() => allOrders.find((o: any) => o.id === id || String(o.id) === String(id)), [allOrders, id]);
  ...
  if (isLoading) {
    return <div className="flex h-[calc(100vh-200px)] w-full items-center justify-center text-muted-foreground">Loading order details...</div>;
  }
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-6">
              <div className="flex flex-col gap-5">
                {order.productImages.map((img: string, i: number) => (
