...
const columns: ColumnDef<CustomerRow>[] = [
  ...
  },
  {
    ...
    header: "Total Spent",
    cell: ({ row }) => <span className="tabular-nums font-medium">৳{row.original.totalSpent.toLocaleString()}</span>,
  },
  {
    id: "statusBadge",
    header: "Status",
    cell: ({ row }) => {
      ...
      return <Badge variant={s === "Registered" ? "default" : "outline"}>{s}</Badge>;
    },
  },
  {
    id: "actions",
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            ...
            onClick={() => toast.success(`Customer ${row.name} deleted.`)}
          >
...
export function CustomersTable() {
  ...
  const countDescription = selectedCount > 0 ? `${selectedCount} of ${totalCount} selected` : `${totalCount} customers`;
            ...
            <div className="flex items-center gap-2">
              ...
              <Dialog open={bulkDeleteOpen} onOpenChange={setBulkDeleteOpen}>
                ...
                <DialogContent>
                  ...
                  <DialogDescription>
                    This action cannot be undone. The selected customers will be permanently removed.
                  </DialogDescription>
                  <DialogFooter>
                    <DialogClose asChild>
