...
import { PurchaseTable, type CustomerPurchaseEntry } from "./_components/purchase-table";

// Mock Data for Customer-wise Purchase History
const allCustomers: CustomerPurchaseEntry[] = [
  { id: "CUST-001", customerName: "Arham Khan", phone: "+880 1711-234567", avatar: "https://placehold.co/40x40/1a1a2e/e0e0e0?text=AK", totalOrders: 15, totalSpent: 45000, lastPurchaseDate: "2026-05-19", status: "Active", customerType: "Registered" },
  { id: "CUST-002", customerName: "Nusrat Jahan", phone: "+880 1614-567890", avatar: "https://placehold.co/40x40/1a1a2e/e0e0e0?text=NJ", totalOrders: 8, totalSpent: 22000, lastPurchaseDate: "2026-05-18", status: "Active", customerType: "Registered" },
  { id: "CUST-003", customerName: "Maliha Sultana", phone: "+880 1918-901234", avatar: "https://placehold.co/40x40/1a1a2e/e0e0e0?text=MS", totalOrders: 1, totalSpent: 1450, lastPurchaseDate: "2026-05-15", status: "Inactive", customerType: "Guest" },
  { id: "CUST-004", customerName: "Imran Haque", phone: "+880 1817-890123", avatar: "https://placehold.co/40x40/1a1a2e/e0e0e0?text=IH", totalOrders: 24, totalSpent: 120500, lastPurchaseDate: "2026-05-10", status: "Active", customerType: "Registered" },
  { id: "CUST-005", customerName: "Fatima Akter", phone: "+880 1812-345678", avatar: "https://placehold.co/40x40/1a1a2e/e0e0e0?text=FA", totalOrders: 3, totalSpent: 4500, lastPurchaseDate: "2026-04-25", status: "Blocked", customerType: "Guest" },
];
    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground text-sm">Track lifetime value, total orders, and purchase history of your customers.</p>
        </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button size="icon" variant="outline" aria-label="More actions"><Ellipsis className="size-4" /></Button>
                </DropdownMenuTrigger>
